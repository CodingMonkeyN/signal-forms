        ...
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          <div class="space-y-5">
            ...
            <div>
              ...
              />
              @if (
                regForm.username().touched() && regForm.username().invalid()
              ) {
                <div class="mt-1 space-y-1">
                  @for (
                    error of regForm.username().errors();
                    track error.kind
                  ) {
            ...
            <div>
              ...
              />
              @if (
                regForm.password().touched() && regForm.password().invalid()
              ) {
                <div class="mt-1 space-y-1">
                  @for (
                    error of regForm.password().errors();
                    track error.kind
                  ) {
                    <p class="text-red-600 text-sm">{{ error.message }}</p>
                  }
        ...
        <div class="space-y-4">
          ...
          <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <ul class="space-y-2 text-blue-900 text-sm">
              <li>
                <strong>validate()</strong> creates custom sync validators
              </li>
              <li>
              ...
              <li>
                <strong>submit()</strong> marks all touched, validates, then
                runs callback
              </li>
